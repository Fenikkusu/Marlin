...
#define STRING_CONFIG_H_AUTHOR "(Fenikkusu, Tevo Tarantula)" // Who made the changes.
...
#define HOTEND_OFFSET_X { 0.0, 17.00 } // (mm) relative X-offset for each nozzle
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 100, 100 }
/**
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -57, -13, -2.75}
